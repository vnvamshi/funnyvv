...
function loadData() {
    try {
        ...
        return { stats: { total_interactions: 2560, learned_patterns: 77, accuracy_score: 92.5 }, memories: [], tables: [] };
    }
}
...
app.post('/api/voice/command', (req, res) => {
    ...
    else if (cmd.includes('how it works')) { response = 'Showing how it works.'; navigate = '/how-it-works'; }
    else if (cmd.includes('partners')) { response = 'Opening Partners.'; navigate = '/partners'; }
...
app.listen(PORT, () => {
    console.log('===================================================================');
    console.log('  VISTAVIEW BACKEND v3.0 - RUNNING');
