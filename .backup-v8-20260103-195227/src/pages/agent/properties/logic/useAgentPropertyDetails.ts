...
function mapApiToPropertyDetails(apiData: any): PropertyDetails {
  ...
  return {
    ...
    agent: apiData.agent_detail || apiData.agent || { id: apiData.agent, username: '', email: '', profile_photo_url: '', mobile_number: '' },
    ...
    listing_strength_percentage: apiData.listing_strength_percentage !== undefined ? Number(apiData.listing_strength_percentage) : 0,
    vr_submitted: apiData.vr_submitted || null,
  };
}

export default function useAgentPropertyDetails() {
