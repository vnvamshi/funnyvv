...
const MobileProfileUpdate: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col px-4 pt-6 pb-4">
      {/* Header */}
      <div className="flex items-center mb-6">
        <button onClick={() => navigate(-1)} className="mr-2">
          <svg width="24" height="24" fill="none" stroke="#17695C" strokeWidth="2" viewBox="0 0 24 24"><path d="M15 18l-6-6 6-6"/></svg>
        </button>
      ...
      <div className="flex flex-col items-center mb-6">
        <div className="w-20 h-20 rounded-full flex items-center justify-center mb-2 relative">
          {profilePhotoUrl ? (
            ...
            <svg width="100" height="100" viewBox="0 0 167 167" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <button 
          type="button" 
          className="text-primary-color text-sm font-semibold flex items-center gap-1 mb-2 hover:underline"
      ...
      {/* Form Fields */}
      <form className="flex flex-col flex-1" onSubmit={handleSubmit(handleFormSubmit)}>
        <div className="mb-4">
        ...
        <div className="flex gap-4 mt-auto mb-2">
          <button
            type="button"
            className="flex-1 border border-[#17695C] rounded-lg py-3 font-semibold text-[#17695C] bg-white hover:bg-[#F3F6F7] transition"
            onClick={() => navigate(-1)}
            disabled={loading}
          >
            Cancel
          ...
          <button
            type="submit"
            className="flex-1 rounded-lg py-3 font-semibold text-white bg-gradient-to-r from-[#17695C] to-[#007E67] hover:from-[#007E67] hover:to-[#17695C] transition shadow"
            disabled={loading}
          >
...
export default MobileProfileUpdate; 